...
document.querySelector("#main").addEventListener("click",function () {
   ...
   if(!animate){
    ...
    index == h.length-1  ? (index = 0) : index++;
    gsap.to(h [index] ,{
        top:"-=100%",
        ease:Expo.easeInOut,
        duration:1,
